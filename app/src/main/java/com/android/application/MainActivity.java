...
import com.android.application.utils.Constants;
import com.android.application.utils.LoadingDialogHandler;
import com.android.vuforia.VuforiaApplicationControl;
import com.android.vuforia.VuforiaApplicationException;
import com.android.vuforia.VuforiaApplicationSession;
...
public class MainActivity extends AndroidHarness implements VuforiaApplicationControl {
    ...
    public MainActivity() {
        ...
        appClass = "com.android.application.JMESurfaceView";
    ...
    public void setRGB565CameraImage(byte[] buffer, int width, int height) {
        ...
        if ((com.android.application.JMESurfaceView) app != null) {
            ((com.android.application.JMESurfaceView) app)
